...
describe('getClosestLocation', function () {
  ...
  it('should find the closest location within the radius', function () {
    const deviceLatitude = 28.6300;  // Example latitude of the device (close to Connaught Place)
    const deviceLongitude = 77.2100;  // Example longitude of the device
  ...
  it('should return null if no location is within the radius', function () {
    ...
    const deviceLongitude = 77.0000;  // Longitude far from the defined locations
  ...
  it('should return the closest location when two locations are equidistant', function () {
    ...
    const deviceLatitude = 28.6330;  // Latitude close to both Connaught Place and Chandni Chowk
    const deviceLongitude = 77.2200;  // Longitude close to both locations
  ...
  it('should return the correct location when it is inside the radius', function () {
    const deviceLatitude = 28.6310;  // Latitude near Connaught Place
  ...
  it('should not return a location outside the radius', function () {
    const deviceLatitude = 28.6510;  // Latitude outside the radius of Connaught Place
    const deviceLongitude = 77.3000;  // Longitude outside the radius
